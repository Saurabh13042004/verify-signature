...
const encryptedSignatureBuffer = Buffer.from(
  inputPayload.ResponseSignatureEncryptedValue,
  "base64"
);
...
try {
  decrypted = Buffer.concat([
    decipher.update(encryptedSignatureBuffer),
    decipher.final(),
  ]);
